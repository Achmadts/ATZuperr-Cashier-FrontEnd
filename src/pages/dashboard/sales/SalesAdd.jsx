...
function SalesCreate() {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      sub_total: addedProducts.map((p) => p.subtotal),
    ...
    try {
      ...
      if (response.ok && result.success) {
        showToast("Sales created successfully!", "success");
        navigate("/dashboard/sales/add");
      } else {
        const errorMessage =
          result.message ||
          "Failed to create sales. Please check the input and try again.";
